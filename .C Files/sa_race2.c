...
void sa_race(void)
{
	...
	SWITCH_ROADS_OFF( -80.075, 1252.765, -1.286, -230.417, 1300.289, 80.0 );// ОТКЛЮЧАЕМ ПУТИ ТРАФИКА
...
//============================== соперник 3 ==============================
	...
	SWITCH_ROADS_BACK_TO_ORIGINAL( -80.075, 1252.765, -1.286, -230.417, 1300.289, 80.0 );//  АКТИВИРУЕМ ТРАФИКА
	REMOVE_BLIP(Blip_r);//Удаляем иконку на радаре
	REMOVE_BLIP(Blip_r2);//Удаляем иконку на радаре
	...
	else if (skip == 2)
	{
		...
		MissionPassed(2000, "youhavewon", "CASH");
